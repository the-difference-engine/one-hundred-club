...
50.times do
  FallenHero.create(
    rank: ["Officer", "Firefighter", "Investigator"].sample, 
    first_name: Faker::Name.first_name, 
    middle_name: Faker::Name.first_name, 
    last_name: Faker::Name.last_name, 
    department: ["Chicago Police", "Chicago Fire Department", "Cook County Sheriff's Department"].sample, 
    date_deceased: Faker::Date.backward(14), 
    description: Faker::Hipster.paragraphs(1)[0], 
